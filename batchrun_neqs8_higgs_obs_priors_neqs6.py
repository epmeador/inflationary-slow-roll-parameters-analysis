...
#NMAX = 0.98
#NMIN = 0.96
#/Users/epmeador/Desktop/research/rwarthur/inflation_gravitywaves/inflation_code/InflationModels/int_de.py
#RMIN = 0
#RMAX = 0.04
#
##ALPHA_TARGET =
...
#lesser wide
#correlated lam3 and lam4, looks like sampled
#LAM2_MIN = -5e-4
#LAM2_MAX = 5e-4
...
def run_neqs8_lam3_models_batch(clean_output=True):
    import shutil
